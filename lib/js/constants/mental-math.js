...
export const newRoundDelay = 500;
...
export const styles = {
  display: `${appStyles.jumbotron}`,
  answer: `${appStyles.btnDefault} ${answer}`,
  rightAnswer: `${appStyles.btnSuccess} ${answer}`,
  wrongAnser: `${appStyles.btnDanger} ${answer}`,
  input: `${appStyles.textRight} input-style`,
  inputSuccess: `${appStyles.textRight} ${appStyles.btnSuccess} input-style`,
  inputDanger: `${appStyles.textRight} ${appStyles.btnDanger} input-style`,
};

export const operationArgumentNames = {
...
export const numberRegex = /^-?(0?|[1-9]\d*)$/;
