...
export default class MentalMath extends Game {
  ...
  getAnswerOperationArgumentName() {
    this.answerOperationArgumentName;
  }
  ...
  chooseAnswer() {
    const n = randInt(1, 3);
    this.answerOperationArgumentName = n === 1 ? opArgs.firstOperand : (n === 2 ? opArgs.secondOperand : opArgs.result);
  }

  hideAnswer() {
    // this.toDisplay[this.answerOperationArgumentName] = symbols.placeHolder;
    this.toDisplay[this.answerOperationArgumentName] = '';
  }
